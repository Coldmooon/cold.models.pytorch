...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, r=16):
        ...
        self.se = SELayer(planes, r)
        self.downsample = downsample
        self.stride = stride

        # self.st32x32 = ST(planes, planes, 32, 32)
        # self.st16x16 = ST(planes, planes, 16, 16)
    ...
    def forward(self, x):
        ...
        # if (out.size(2) == 32):
        #     out = self.st32x32(out)
        # elif (out.size(2) == 16):
        #     out = self.st16x16(out)
...
class ResNetCIFAR(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=10, r=16):
        ...
        self.st32x32.fc.weight.data.zero_()
        self.st32x32.fc.bias.data.copy_(torch.tensor([1, 0, 0, 0, 1, 0], dtype=torch.float))
