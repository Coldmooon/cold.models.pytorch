...
python main_sequence.py -a $model -b 128 --lr 0.01 --wd 0.0005 --epochs 240 --save $directory --dataset $dataset --se-reduce 16 --gpu 1 /home/coldmoon/Datasets/SVHN/LMDB | tee ${directory}/log.txt
